...
as_vec2f as_vec2f_mul_float(as_vec2f vec, float scale);
as_vec2f as_vec2f_div_float(as_vec2f vec, float scale);
...
as_vec2f as_vec2i_mul_float(as_vec2i vec, float scale);
as_vec2f as_vec2i_div_float(as_vec2i vec, float scale);
...
as_vec3f as_vec3f_mul_float(as_vec3f vec, float scale);
as_vec3f as_vec3f_div_float(as_vec3f vec, float scale);
...
as_vec3f as_vec3i_mul_float(as_vec3i vec, float scale);
as_vec3f as_vec3i_div_float(as_vec3i vec, float scale);
